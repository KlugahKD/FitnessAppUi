<template>
  <div class="bg-white min-h-screen">
    <div class="max-w-7xl mx-auto p-6 space-y-8">
      <!-- Hero Section -->
      <div
        class="bg-gradient-to-r from-green-50 to-green-100 border-l-4 border-green-400 rounded-2xl p-6 mb-6"
      >
        <div class="flex items-center">
          ...
          <div class="ml-auto">
            <div class="bg-black bg-opacity-5 p-2 rounded-full">
              <div
                class="w-10 h-10 bg-A3F300 rounded-full flex items-center justify-center"
              >
                <svg
      ...
      <div>
        ...
        <div v-if="status === 'complete'">
          <div v-if="currentWorkoutsData.length === 0" class="text-center py-8">
            <div
              class="bg-f6fef2 rounded-2xl p-8 flex flex-col items-center shadow-sm"
            >
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div class="p-6">
              <div
                class="h-6 w-1/2 bg-gray-200 rounded-full mb-4 animate-pulse"
              ></div>
              <div
                class="h-4 w-3/4 bg-gray-200 rounded-full mb-3 animate-pulse"
              ></div>
              <div
                class="h-4 w-1/2 bg-gray-200 rounded-full mb-6 animate-pulse"
              ></div>
              <div
                class="h-12 w-full bg-gray-200 rounded-xl animate-pulse"
              ></div>
            </div>
          </div>
        </div>
      ...
      <div
        v-if="status === 'complete' && pastWorkoutsData.length === 0"
